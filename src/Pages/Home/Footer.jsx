  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://web.facebook.com/ruvindya.sachinthani.9"
            ...
            <li>
              <a
                href="https://www.instagram.com/ruvi_sachi/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ruvindya-sachinthani/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/RuvindyaS"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Developed By Sachinthani W.M.R</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
